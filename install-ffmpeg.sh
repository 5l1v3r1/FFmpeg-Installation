...
wget --no-check-certificate https://raw.githubusercontent.com/ShekharSumanPro/FFmpeg-Installation/master/auto-ffmpeg.repo -O /etc/yum.repos.d/auto-ffmpeg.repo
